...
if (document.querySelector(".header-section--mobile")) {
    ...
    if (window.innerWidth <= 775 || window.getWindowSize()[0] <= 775) {
        var main = document.querySelector("main");
        main.style.marginTop = "50px";
        var sidebar = document.getElementById("sidebar");
        sidebar.classList.add("js--transformed");
    } else {
        document
...
if (document.getElementById("openMenu")) {
    ...
    mobileButtonOpen.addEventListener("click", function() {
        ...
        sidebar.classList.toggle("js--transformed");
        sidebar.classList.toggle("js--opened");
        document.querySelector(".site-content").classList.toggle("js--hidden");
    });
...
if (document.getElementById("complexNavItem")) {
